...
export class ZxError extends Error {
  ...
  public static fromResponse(resp: {error?: any, exception?: any}): ZxError {
    ...
    if (
      (typeof resp !== "undefined" && resp !== null)
  ...
  public static buildStackTrace(
    ...
    if (error.hasOwnProperty("isZxError")) {
      ...
      || ((typeof (error as AjxException).toString !== "undefined"
  ...
  constructor(code?: string, cause?: Error) {
    ...
    if (typeof code === "string") {
      if (
        (typeof ZxErrorCode !== "undefined" && ZxErrorCode !== null)
        && !ZxErrorCode.hasOwnProperty(code)
        && !/test/ig.test(code)
      ) {
  ...
  public toJSON(): {[property: string]: any} {
    ...
    if (typeof this.mCause !== "undefined" && this.mCause !== null) {
      obj[ZxError.KEY_CAUSE] = (this.mCause as ZxError).toJSON();
    } else {
  ...
  public getMessage(br: string = "<br>"): string {
    ...
    for (const key in this.mDetails) {
