...
import {ShutdownEvent} from "../../client/events/chat/ShutdownEvent";
import {IChatClient} from "../../client/IChatClient";
import {ReduxEventHandler} from "./ReduxEventHandler";

export class ShutdownReduxEventHandler extends ReduxEventHandler<ShutdownEvent> {
  public getEventCode(): number {
    return OpenChatEventCode.SHUTDOWN;
  }

  public handleEvent(ev: ShutdownEvent, client: IChatClient): boolean {
    // client.stopPing();
